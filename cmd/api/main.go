...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "22b02ba52ae74d", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "aece70392afcc7", "SMTP password")
